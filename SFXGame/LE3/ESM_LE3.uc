...
defaultproperties
{
    Settings = {
                ...
                SpecialRules = ({Path = "proear_crashedchopper_v_d.node_data_sequence:bioseqevt_convnode_0", Delay = 1.0, Type = CooldownType.Conversation_Start}, 
                                ...
                                {Path = "biod_promar_240exteriorwalk.theworld:persistentlevel.main_sequence.airlock_and_helmet.sequencereference_1.ref_playerhelmetcontrol.bioseqact_biotogglecinematicmode_1", Delay = 0.0, Type = CooldownType.Non_Conversation_Start}, 
                                {Path = "biod_cithub_001procit.theworld:persistentlevel.main_sequence.bioseqact_biotogglecinematicmode_1", Delay = 3.0, Type = CooldownType.Non_Conversation_Start}, 
                                {Path = "biod_nor_110tour.theworld:persistentlevel.main_sequence.dream01.start_stage_2.bioseqact_biotogglecinematicmode_1", Delay = 0.0, Type = CooldownType.Non_Conversation_Start}, 
                                {Path = "biod_kro002_860threesec.theworld:persistentlevel.main_sequence.bioseqact_biotogglecinematicmode_1", Delay = 0.0, Type = CooldownType.Non_Conversation_Start}, 
                                {Path = "biod_nor_204kro002_debrief.theworld:persistentlevel.main_sequence.bioseqact_biotogglecinematicmode_3", Delay = 1.0, Type = CooldownType.Non_Conversation_Start}, 
                                {Path = "biod_cat003_080introcutscene.theworld:persistentlevel.main_sequence.intro_sequence.bioseqact_biotogglecinematicmode_0", Delay = 0.0, Type = CooldownType.Non_Conversation_Start}, 
                                {Path = "biod_cat003_600elevatortrans.theworld:persistentlevel.main_sequence.bioseqact_biotogglecinematicmode_1", Delay = 7.0, Type = CooldownType.Non_Conversation_Start}, 
